<template>
    <el-dialog :model-value="isOpen" @update:model-value="!$event && $emit('close')" title="Gestão de Identidade (CRM)"
                    ...
                    <el-form label-position="top" class="enterprise-form">
                        <el-form-item label="Buscar Cliente na Base" class="!mb-6">
                            <el-select v-model="linkForm.customerUuid" filterable remote
                                :remote-method="remoteSearchCustomer" :loading="loadingSearch"
                                class="w-full enterprise-select"
                            ...
                            <p class="text-[11px] font-medium text-slate-400 mt-2 flex items-center gap-1.5">
                                <el-icon>
                                    <InfoFilled />
                                </el-icon> Selecione um cliente já registado para vincular a este número de WhatsApp.
                            </p>
                        </el-form-item>

                        <div v-if="linkForm.customerUuid"
                            class="animate-in fade-in slide-in-from-top-4 duration-300 border-t border-slate-100 pt-5">
                            <el-form-item label="Nome da Pessoa de Contato *" required class="!mb-2">
                                ...
                                <p class="text-[11px] text-indigo-500 font-bold mt-1.5">Identifique o nome de quem está
                                    falando deste
                                    número dentro da empresa selecionada.</p>
                            </el-form-item>
                        </div>
                    </el-form>
                </div>
                ...
                <div class="bg-white border border-slate-200 rounded-xl mt-4 shadow-sm overflow-hidden h-[380px]">
                    <el-form ref="newCustomerFormRef" :model="newCustomerForm" :rules="formRules" label-position="top"
                        ...
                        <el-tabs v-model="activeInnerTab"
                            class="enterprise-inner-tabs px-6 pt-3 bg-slate-50 border-b border-slate-100">
                                ...
                                <div
                                    ...
                                    <div class="col-span-1 sm:col-span-2">
                                        <el-form-item label="Tipo Jurídico" class="!mb-2">
                                            <el-radio-group v-model="newCustomerForm.type" size="default"
                                                ...
                                                <el-radio-button value="PF">Pessoa Física (PF)</el-radio-button>
                                                <el-radio-button value="PJ">Pessoa Jurídica (PJ)</el-radio-button>
                                            </el-radio-group>
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-2">
                                        <el-form-item
                                            ...
                                            <el-input v-model="newCustomerForm.name" class="enterprise-input"
                                                placeholder="Digite o nome..." />
                                        </el-form-item>
                                    </div>
                                    <div v-if="newCustomerForm.type === 'PJ'" class="col-span-1 sm:col-span-2">
                                        <el-form-item label="Nome Fantasia" class="!mb-2">
                                            <el-input v-model="newCustomerForm.tradeName" class="enterprise-input"
                                    ...
                                    <div>
                                        <el-form-item label="Telefone / WhatsApp (Vinculado)" class="!mb-2">
                                            <el-input v-model="newCustomerForm.phone" disabled
                                                class="enterprise-input !bg-slate-50" />
                                        </el-form-item>
                                    </div>
                                    <div>
                                        <el-form-item label="E-mail Principal" class="!mb-2">
                                            <el-input v-model="newCustomerForm.email" class="enterprise-input"
                                ...
                                <div
                                    ...
                                    <div class="col-span-1 sm:col-span-4">
                                        <el-form-item label="CEP" class="!mb-2">
                                            <el-input v-model="newCustomerForm.zipCode" class="enterprise-input"
                                                placeholder="00000-000" @blur="fetchCep" />
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-8">
                                        <el-form-item label="Logradouro" class="!mb-2">
                                            <el-input v-model="newCustomerForm.street" class="enterprise-input"
                                    ...
                                    <div class="col-span-1 sm:col-span-4">
                                        <el-form-item label="Número" class="!mb-2">
                                            <el-input v-model="newCustomerForm.number" id="numero-input"
                                                class="enterprise-input" placeholder="123" />
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-8">
                                        <el-form-item label="Complemento" class="!mb-2">
                                            <el-input v-model="newCustomerForm.complement" class="enterprise-input"
                                                placeholder="Apto 45, Bloco B" />
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-5">
                                        <el-form-item label="Bairro" class="!mb-2">
                                            <el-input v-model="newCustomerForm.neighborhood" class="enterprise-input"
                                                placeholder="Centro" />
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-5">
                                        <el-form-item label="Cidade" class="!mb-2">
                                            <el-input v-model="newCustomerForm.city" class="enterprise-input"
                                                placeholder="São Paulo" />
                                        </el-form-item>
                                    </div>
                                    <div class="col-span-1 sm:col-span-2">
                                        <el-form-item label="UF" class="!mb-2">
                                            <el-input v-model="newCustomerForm.state" class="enterprise-input"
                            ...
                            <el-tab-pane label="Dados Adicionais" name="additional">
                                <div class="p-8 bg-white h-[320px] overflow-y-auto custom-scroll">
                                    <div
                                        class="bg-blue-50/50 border border-blue-100/50 rounded-2xl p-6 mb-6 flex items-start gap-4">
                                        <div
                                        ...
                                        <div>
                                            <h4 class="text-sm font-bold text-slate-800 mb-1">Classificação de Origem
                                            </h4>
                                            <p class="text-xs text-slate-500 leading-relaxed">
                                                Identificar de onde este cliente veio ajuda a medir a eficiência dos
                                                seus canais de
                                                aquisição (Ex: Instagram, Indicação, Google).
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="max-w-md">
                                        <el-form-item label="Origem do Cliente / Lead" class="!mb-2">
                                            <el-select v-model="newCustomerForm.source" class="w-full enterprise-select"
                                                filterable :loading="sourceStore.isLoading"
                                                placeholder="Selecione a origem deste lead/cliente...">
                                                <template #prefix><el-icon>
                                                        <Promotion />
                                                    </el-icon></template>
        ...
        <template #footer>
            <div
                class="flex border-t border-slate-100 bg-slate-50 -mx-4 -mb-4 px-6 py-4 rounded-b-lg justify-end gap-3 mt-4">
                <el-button @click="$emit('close')" class="!rounded-lg !px-6 !font-bold">Cancelar</el-button>
                <el-button type="primary" class="!rounded-lg !px-8 !font-black tracking-wide shadow-md"
                    @click="handleConfirm">
