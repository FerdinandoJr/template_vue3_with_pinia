<template>
    <el-dialog :model-value="isOpen" @update:model-value="!$event && $emit('close')" width="850px" destroy-on-close
        align-center class="rounded-xl overflow-hidden shadow-2xl">
        <template #header>
        ...
        <div v-if="article" class="py-2">
            ...
            <div class="bg-white p-8 rounded-xl border border-slate-200 shadow-sm rich-text-content"
...
const props = defineProps<{ isOpen: boolean; article: IKbArticle | null }>();
