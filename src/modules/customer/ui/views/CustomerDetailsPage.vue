        ...
        <div v-else-if="customer" class="max-w-6xl mx-auto space-y-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-2">
                    ...
                    <el-button v-permission="['ADMIN']" type="danger" plain @click="promptDelete">
                        <el-icon class="mr-2">
                            <Delete />
                        </el-icon>
                        Excluir
...
import { ArrowLeft, Edit, Delete, Phone, Message, Link, OfficeBuilding, Location, TrendCharts } from '@element-plus/icons-vue'
